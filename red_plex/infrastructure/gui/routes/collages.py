...
from red_plex.infrastructure.cli.utils import push_collections_to_upstream
                    ...
                    for collage in selected_collages:
                        try:
                            ...
                            logging.getLogger('red_plex').error(
                                'Error getting preview for collage %s: %s', collage.name, e)
                            continue
                    ...
                    def process_upstream_sync():
                        ...
                        try:
                            ...
                            for collage_id, group_ids in albums_data.items():
                                ...
                                try:
                                    gazelle_api = GazelleAPI(collage.site)
                                    result = gazelle_api.add_to_collage(collage.external_id, group_ids)
